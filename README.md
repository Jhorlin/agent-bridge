...
| Plugins | Portable skill-package directories, common manifest metadata, supporting files; source builds also support bounded conventional hooks and allowlisted MCP in compatibility layout | No installation/cache refresh, OAuth, marketplace management, portable-layout hooks/MCP, agents, app mappings, custom component paths, or host-specific fields |
