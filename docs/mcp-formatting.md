...
scalar values, only those value tokens change. This includes individual elements
of same-length arrays and scalar leaves inside inline tables. Surrounding whitespace, key order,
...
servers, array-length changes, container/type-shape changes and TOML documents containing array
...
array comments/trailing commas, nested inline tables, unchanged nested data,
structural fallback, forward/reverse sync, idempotence,
