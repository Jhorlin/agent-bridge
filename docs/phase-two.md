...
| 7 | Drift resolution | Reviewed conflict decisions; renames/deletions/history selection; preview; stale-input refusal and exact rollback | Reviewed side/history choices plus journaled supporting-file rename/delete and reviewed undo implemented; whole-resource/entry-point retirement remains pending |
