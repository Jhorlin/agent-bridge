...
| Conflict / drift handling | Baselines, reviewed side/history choices and supporting-file rename/delete in source builds | No last-writer-wins; entry-point/whole-resource retirement remains unsupported. [Drift workflow](conflict-resolution.md), [file changes](supporting-file-changes.md) |
