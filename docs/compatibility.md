...
| Conflict / drift handling | Baselines, reviewed side/history choices, supporting-file rename/delete and reviewed historical undo | No last-writer-wins; entry-point/whole-resource retirement remains unsupported. [Drift workflow](conflict-resolution.md), [file changes](supporting-file-changes.md) |
